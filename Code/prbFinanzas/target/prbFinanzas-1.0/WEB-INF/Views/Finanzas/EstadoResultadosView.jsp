                                ...
                                <div class="panel-body">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <h3 class="panel-title text-left">Estado de Resultados</h3>
                                        </div>
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label text-left" for="inputError">Periodo </label>
                                                                <select id="selectmes" class="form-control" onchange="validarDropDown('Selectmes')">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <!-- inputs/!-->
                                                            <div class="form-group">
                                                                <label class="control-label text-left" for="inputError">Año </label>
                                    ...
                                    <form action="ReporteEstadoResultadosView" method="post">
                                        <div class="row">
