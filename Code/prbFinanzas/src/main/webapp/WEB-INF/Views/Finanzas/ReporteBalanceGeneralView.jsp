    ...
    <div id="wrapper">
                        ...
                        <div class="panel-body">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title text-left">Balance General Septiembre 2014</h3>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-offset-3 text-center">
                                            <div class="row">
                <div class="col-md-2">
                    <H4><strong>CONCEPTO</strong></H4>
                </div>
                <div class="col-md-2">
                    <H4><strong>DEBE</strong></H4>
                </div>
                <div class="col-md-2">
                    <H4><strong>HABER</strong></H4>
                </div>        
            </div>
            <br>
            <!-- Primera fila -->
        ...
        <div class="form-group input-group">
            <span class="input-group-addon">
                ...
                <input class="form-control" type="text" value="2,500.00" disabled></input>
            </div>
            </div>
        ...
        <div class="form-group input-group">
            <span class="input-group-addon">
                ...
                <input class="form-control" type="text" value="2,800.00" disabled></input>
            </div>
            </div>
        ...
        <div class="form-group input-group">
            <span class="input-group-addon">
                ...
                <input class="form-control" type="text" value="3,000.00" disabled></input>
            </div>
            </div>
        ...
        <div class="form-group input-group">
            <span class="input-group-addon">
                ...
                <input class="form-control" type="text" value="50,000.00" disabled></input>
            </div>
            </div>
        ...
        <div class="form-group input-group">
            <span class="input-group-addon">
                ...
                <input class="form-control" type="text" value="3,800.00" disabled></input>
            </div>
            </div>
        ...
        <div class="form-group input-group">
            <span class="input-group-addon">
                ...
                <input class="form-control" type="text" value="4,000.00" disabled></input>
            </div>
            </div>
        ...
        <div class="form-group input-group">
            <span class="input-group-addon">
                ...
                <input class="form-control" type="text" value="70,000.00" disabled></input>
            </div>
            </div>
        ...
        <div class="form-group input-group">
            <span class="input-group-addon">
                ...
                <strong><input class="form-control" type="text" value="127,800.00" disabled></input></strong>
            </div>
            </div>
            <div class="col-md-2 col-lg-2">
        <div class="form-group input-group">
