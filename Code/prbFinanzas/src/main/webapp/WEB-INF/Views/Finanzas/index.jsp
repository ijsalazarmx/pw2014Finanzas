                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            SAC <small>Departamento de Finanzas</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                Bienvenido
                        ...
                        <div class="row">
                           <div class="col-md-offset-1 col-lg-4" align="right">
                                ...
                                <br>
                                <br>
                                <img src="${pageContext.request.contextPath}/resources/image/finanzas/finanzas.jpg" class="img-rounded" width="700" height="400">
                                <br>
                            </div>
                        </div>  
                    </div>
